      ...
      <Modal isOpen={modalOpen} onClose={() => setModalOpen(false)} title={editingId ? "Edit Event" : "New Event"}>
        <div className="space-y-4">
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
            ...
            <button onClick={handleSave} disabled={saving || !form.title} className="px-5 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-school-gold to-secondary rounded-xl shadow-glow-gold hover:shadow-lg transition-all disabled:opacity-50 flex items-center gap-2">
